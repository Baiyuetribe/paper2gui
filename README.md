...
- [小白兔AI - 付费订阅](https://xiaobaituai.com)

> 统一、全面、高效的小白兔AI，依赖强大的自研AI引擎，整合并持久优化，现已支持抠图、人像动漫化、动漫超分辨、音频降噪、语音合成等十余种AI功能，GPU加速推理Inter、NVDIA、AMD全支持。
...
开发者计划：
- AI新功能：语音识别、OCR识别+视频字幕提取、人脸修复、旧图片上色修复、多目标抠图等等
